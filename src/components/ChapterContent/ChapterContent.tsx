        ...
        switch (block.type) {
          case "heading":
            if (block.level === 2) {
              return (
                <h2
                  key={index}
                  className="text-2xl lg:text-4xl font-bold text-white mt-10"
                >
                  {block.text}
                </h2>
              );
            ...
            return (
              <h3
                key={index}
                className="text-xl lg:text-[28px] font-semibold text-white/90 mt-8"
              >
                {block.text}
              </h3>
            );
          ...
          case "paragraph":
            return (
              <p
                key={index}
                className="text-white/70 leading-8 text-sm lg:text-[26px]"
              >
                {block.text}
              </p>
            );
          ...
          case "batuques":
            return <BatuquePlayer key={index} batuques={block.batuques} />;

          case "image-pair":
            return (
              <div
                key={index}
                className="mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 my-8 max-w-4xl"
              >
